...
does not describe the specific instance, but the general pattern.

, because the _itself_ part is what the specific _conceptual model_ is. So if it is a conceptual model of _chess_, then the very conceptual model _itself_, is the description of _itself_. Any conceptual model
